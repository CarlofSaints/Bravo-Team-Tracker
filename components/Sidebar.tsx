    ...
    <>
      ...
      >
        ...
        <nav className="flex-1 px-3 py-4 flex flex-col gap-1 overflow-y-auto">
            ...
            <div className="mt-1">
              <button
                ...
                className={`w-full flex items-center justify-between px-4 py-2.5 rounded-lg text-sm font-medium transition-colors ${
                  ['/channels', '/teams', '/regions', '/stores', '/settings', '/data-import', '/activity-log'].includes(pathname)
              ...
              {ccExpanded && (
                <div className="ml-3 mt-0.5 flex flex-col gap-0.5 border-l border-white/10 pl-2">
                  ...
                  <NavLink href="/data-import" label="Data Import" active={pathname === '/data-import'} />
                  <NavLink href="/settings" label="Settings" active={pathname === '/settings'} />
                  <NavLink href="/activity-log" label="Activity Log" active={pathname === '/activity-log'} />
                </div>
              )}
            </div>
          )}
          ...
          <NavLink href="/training" label="Training" active={pathname === '/training'} />
